...
public class Cuenta {
	...
	// Cuando usamos herencia, es necesario cambiar private por protected para
	...
	/**
	 * 
	 * @param valorDeposito: representa el valor a depositar en la cuenta
	 * @return saldo actualizado de la cuenta
	 */
	public float depositoCuenta(float valorDeposito) {
		saldoCuenta += valorDeposito;
		return saldoCuenta;
	}
